...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/namespace-alias2standalone/tags). For example,

```javascript
alias2standalone = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/namespace-alias2standalone@v0.3.0-umd/browser.js' )
```
